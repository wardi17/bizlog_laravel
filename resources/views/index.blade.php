                    ...
                    <div class="col-lg-7 col-md-9">
                        <div class="bar-content">
                            <ul class="list-unstyled list-inline">
                                ...
                                <li class="list-inline-item"><img src="assets/images/clock.png" alt="">24 Hours Service</li>
                                <li class="list-inline-item"><img src="assets/images/mail.png" alt="">BJI@Bidzlog.com</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="main-menu text-right">
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item active"><a href="index.html" >Beranda <i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="list-inline-item"><a>Profil <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="05-about-us.html">Tentang kami</a></li>
                                        <li><a href="struktur_organisasi.html">Struktur Organisasi</a></li>
                                        <li><a href="08-service-three.html">Area Peti Zona</a></li>
                                        <li><a href="09-service-details.html">Sistem Parkir</a></li>
										<li><a href="09-service-details.html">Sistem Forwarder</a></li>
										
                                    </ul>
                                </li>
                                <li class="list-inline-item"><a>Berita & Kegiatan <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="05-about-us.html">Siaran Pres</a></li>
                                        <li><a>Pengaduan <i class="fa fa-angle-right"></i></a>
                                            <ul class="dropdown2 list-unstyled">
                                                <li><a href="12-department-one.html">Pengaduan Parkir </a></li>
                                                <li><a href="13-department-two.html">Pengaduan Pelayanan</a></li>
                                                <li><a href="13-department-two.html">Pengaduan Forwarder</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li><a>Faq <i class="fa fa-angle-right"></i></a>
                                            <ul class="dropdown2 list-unstyled">
											    <li><a href="20-faq-one.html">Faq Registrasi</a></li>
                                                <li><a href="20-faq-one.html">Faq Parkir</a></li>
                                                <li><a href="21-faq-two.html">Faq Pembayaran</a></li>
												<li><a href="21-faq-two.html">Faq Forwarder</a></li>
                                            </ul>
                                        </li>
                                ...
                                <li class="list-inline-item"><a>Pelayanan <i class="fa fa-angle-down"></i></a>
                                    <ul class="dropdown list-unstyled">
                                        <li><a href="depot_parkir.html">Depot Parkir</a></li>
                                        <li><a href="28-blog-two.html">Pencucian</a></li>
                                        <li><a href="29-blog-three.html">Perbaikan</a></li>
                                        <li><a href="30-blog-sidebar-one.html">Pergerakan Kontainer </a></li>
										<li><a href="31-blog-sidebar-two.html">Kanatin </a></li>
                                        
                                    </ul>
                                </li>
                                <li class="list-inline-item"><a>Kontak <i class="fa fa-angle-down"></i></a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="m-dept">
                                                    ...
                                                    <div class="dept-box">
                                                        <a href="">Komisaris</a>
                                                        <a href="">Direktur Utama</a>
                                                        <a href="">General Manager Marketing</a>
                                                        <a href="">General Manager SDM</a>
                                                        <a href="">General Manager Operasional</a>
                                                        <a href="">General Manager Farwader</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 services-lft">
                        <div class="service-box d-flex flex-row-reverse text-right">
                            <div class="box-icon">
                                <span><img src="assets/images/service-1.png" alt=""></span>
                            </div>
                        ...
                        <div class="service-box d-flex flex-row-reverse text-right">
                            <div class="box-icon">
                                <span><img src="assets/images/service-2.png" alt=""></span>
                            </div>
                            <div class="box-content">
                        ...
                        <div class="service-box d-flex flex-row-reverse text-right">
                            <div class="box-icon">
                                <span><img src="assets/images/service-3.png" alt=""></span>
                            </div>
                            <div class="box-content">
                        ...
                        <div class="service-box d-flex flex-row-reverse text-right">
                            <div class="box-icon">
                                <span><img src="assets/images/service-4.png" alt=""></span>
                            </div>
                            <div class="box-content">
							...
							<div class="containervideo">
								<div class="contentvideo">
									<video width="640" height="340" autoplay loop muted>
										<source src="assets/images/video/bidzcakug.mp4" type="video/mp4">
                    ...
                    <div class="col-lg-4 col-md-6 services-ryt">
                        <div class="service-box d-flex">
                            <div class="box-icon">
                                <span><img src="assets/images/service-5.png" alt=""></span>
                            </div>
                            <div class="box-content">
                        ...
                        <div class="service-box d-flex">
                            <div class="box-icon">
                                <span><img src="assets/images/service-6.png" alt=""></span>
                            </div>
                            <div class="box-content">
                        ...
                        <div class="service-box d-flex">
                            <div class="box-icon">
                                <span><img src="assets/images/service-7.png" alt=""></span>
                            </div>
                            <div class="box-content">
                                <h6>Logistik </h6>
                        ...
                        <div class="service-box d-flex">
                            <div class="box-icon">
                                <span><img src="assets/images/service-8.png" alt=""></span>
                            </div>
                            <div class="box-content">
                                <h6>Forwarder</h6>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="about-box">
                            ...
                            <img src="assets/images/heartbeat2.png" alt="">
...
Forwarder biasanya menangani pengiriman barang dalam jumlah besar dan berat. 
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-1.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="cardio" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-2.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="neuro" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-3.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="gastro" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-4.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="urology" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-5.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="dental" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-6.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="gyneco" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-7.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="child" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 image-box">
                                            <img src="assets/images/tab-8.jpg" alt="" class="img-fluid">
                                            <a href="">Baca Selanjutnya</a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="owl-doctor owl-carousel">
                            <div class="carousel-content">
                                <img src="assets/images/doc-1.png" alt="" class="img-fluid">
                            ...
                            <div class="carousel-content">
                                <img src="assets/images/doc-2.png" alt="" class="img-fluid">
                                <div class="doc-content text-center">
                                    <h5>Maria Perry</h5>
                                    <p>Profesional forwarder</p>
                                    <ul class="list-unstyled list-inline">
                            ...
                            <div class="carousel-content">
                                <img src="assets/images/doc-3.png" alt="" class="img-fluid">
                                <div class="doc-content text-center">
                                    <h5>David Jones</h5>
                                    <p>Profesional forwarder</p>
                                    <ul class="list-unstyled list-inline">
                            ...
                            <div class="carousel-content">
                                <img src="assets/images/doc-4.png" alt="" class="img-fluid">
                                <div class="doc-content text-center">
                                    <h5>Alisha Perry</h5>
                                    <p>Profesional forwarder</p>
                                    <ul class="list-unstyled list-inline">
                    ...
                    <div class="col-md-12">
                        <div class="owl-testimonial owl-carousel">
                            <div class="testimonial-content text-center">
                                <img src="assets/images/patient-1.jpg" alt="" class="img-fluid">
                                <h5>Amily Brown</h5>
                                <span>Customer</span>
                            ...
                            <div class="testimonial-content text-center">
                                <img src="assets/images/patient-2.jpg" alt="" class="img-fluid">
                                <h5>George Dabis</h5>
                                <span>Customer</span>
                                <p>Kami sangat puas dengan layanan [Nama Forwarder]. Pengiriman tepat waktu dan tim mereka sangat responsif terhadap pertanyaan kami. Proses pengurusan dokumen juga sangat efisien. Sangat direkomendasikan!" – .</p>
                            </div>
                        ...
                        <div class="gallery-items row">
                            <div class="col-lg-3 col-md-4 grid-item car">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-1.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item neur">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-2.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item car">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-3.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item neur">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-4.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item den">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-5.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item chi">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-6.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item den">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-7.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-4 grid-item chi">
                                <div class="gallery-content">
                                    ...
                                    <div class="fc-icon text-center">
                                        <a href="assets/images/gallery-8.jpg"><img src="assets/images/focus.png" alt=""></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="counter-box">
                            <img src="assets/images/counter-1.png" alt="" class="img-fluid">
                    ...
                    <div class="col-md-3">
                        <div class="counter-box">
                            <img src="assets/images/counter-2.png" alt="" class="img-fluid">
                    ...
                    <div class="col-md-3">
                        <div class="counter-box">
                            <img src="assets/images/counter-3.png" alt="" class="img-fluid">
                    ...
                    <div class="col-md-3">
                        <div class="counter-box">
                            <img src="assets/images/counter-4.png" alt="" class="img-fluid">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="news-box">
                            <div class="news-image">
                                <a href=""><img src="assets/images/news-1.jpg" alt="" class="img-fluid"></a>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="news-box">
                            <div class="news-image">
                                <a href=""><img src="assets/images/news-2.jpg" alt="" class="img-fluid"></a>
                            </div>
                            <div class="news-heading d-flex">
                                <div class="news-date text-center">
                                    <p>11<br> Apr</p>
                    ...
                    <div class="col-md-4">
                        <div class="news-box">
                            <div class="news-image">
                                <a href=""><img src="assets/images/news-3.jpg" alt="" class="img-fluid"></a>
                            </div>
                            <div class="news-heading d-flex">
                                <div class="news-date text-center">
                                    <p>13<br> Apr</p>
                    ...
                    <div class="col-md-3">
                        <div class="qlink">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><i class="fa fa-angle-right"></i><a href="">Lokasi Parkir</a></li>
                                <li><i class="fa fa-angle-right"></i><a href="">Pencucian</a></li>
                                <li><i class="fa fa-angle-right"></i><a href="">Perbaikan</a></li>
                                <li><i class="fa fa-angle-right"></i><a href="">Pembayaran</a></li>
                                <li><i class="fa fa-angle-right"></i><a href="">Kantin</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-3">
